...
export function isAutoUpdaterDisabled(): boolean {
  // CUSTOM: Anthropic auto-updater permanently disabled
  return true
}
...
export function getAutoUpdaterDisabledReason(): AutoUpdaterDisabledReason | null {
  // CUSTOM: Anthropic auto-updater permanently disabled in favor of custom update system
  return { type: 'env', envVar: 'CUSTOM_UPDATE_SYSTEM' }
}
